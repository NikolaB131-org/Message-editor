...
const crossSvg = (
  <svg className={styles.delete_button_svg} width="800" height="800" viewBox="0 0 800 800" fill="white" xmlns="http://www.w3.org/2000/svg">
...
export function IfThenElseSection({ node }: Props) {
  ...
  return (
    <div className={styles.container}>
      <div className={styles.delete_button_and_stroke}>
        <Button className={styles.delete_button} onClick={() => deleteSection(node.id)}>
          {crossSvg}
        </Button>
      ...
      <div className={styles.blocks}>
        <SectionIdContext.Provider value={{ getCurrentSectionId }}>
          ...
          <Block type={BlockType.Then} data={node[BlockType.Then]} />
          <Block type={BlockType.Else} data={node[BlockType.Else]} />
